...
async function testRegion(region) {
  ...
  const connectionString = `postgresql://postgres.${ref}:${password}@${host}:5432/postgres`;
...
async function main() {
  console.log("Scanning all regional poolers on port 5432...");

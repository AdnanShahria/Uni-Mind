      ...
      {stats.map((stat, i) => {
        ...
        return (
          <motion.div
            ...
            className={`relative p-4 lg:p-5 rounded-2xl bg-gradient-to-br ${stat.color} border ${stat.borderColor} overflow-hidden group cursor-pointer`}
          >
            ...
            <div className="relative z-10 flex items-start justify-between mb-3">
              <div className="w-10 h-10 lg:w-11 lg:h-11 rounded-xl bg-white/[0.07] border border-white/[0.1] flex items-center justify-center shrink-0">
            ...
            <div className="relative z-10">
              <p className="text-[10px] sm:text-[11px] uppercase tracking-wider text-slate-400 font-semibold font-poppins leading-tight mb-1">{stat.label}</p>
              <p className="text-2xl lg:text-3xl font-bold text-white font-outfit leading-none mb-1">{stat.value}</p>
